...
2. **모델링**
   ...
   **예측 모델일 경우**
   ...
   - 컬럼이 row건보다 많을 경우 PLS기법을 사용하는 것이 바람직함, 그렇지 않다면 Neural Network, RF 등의 방법을 사용해도 됨
   ...
   **추천 모델일 경우**
   ...
   - 발생 빈도에 따라 단발적으로 하는 행동 그룹과 반복적으로 하는 행동 그룹으로 분류
   ...
   - 앞에서 한 행동을 X로 뒤이어 이어지는 행동을 Y로 놓고 머신러닝 학습
